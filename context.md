...
- Release automation includes a weekly workflow that auto-bumps patch version, commits manifests, tags `vX.Y.Z`, publishes signed installers for Windows, macOS, and Linux, and uses fully autogenerated GitHub release titles and bodies from commit history.
- Release workflows use `actions/checkout@v5`, `actions/setup-node@v5`, and `node-version: 24` to align with GitHub Actions Node 24 runtime.
- Repository license is MIT with attribution notice requirements; copyright for code authored by Shri Srimoy Trivedy remains with Shri Srimoy Trivedy.
...
- key_items: publish-tauri, actions/checkout@v5, actions/setup-node@v5, node-version:24, tauri-apps/tauri-action@action-v0.6.2, releaseName, matrix: windows-latest|macos-latest|ubuntu-22.04, generateReleaseNotes

### .github/workflows/weekly-release.yml

- type: text
- lines: 177
- first_non_empty: name: weekly-release
- key_items: prepare-release, publish-release, schedule: every Monday at 09:00 UTC, actions/checkout@v5, actions/setup-node@v5, node-version:24, tauri-apps/tauri-action@action-v0.6.2, releaseName, generateReleaseNotes
...
- type: text
- lines: 25
- first_non_empty: # MIT License
- key_items: attribution-required-notice, Shri Srimoy Trivedy
...
- type: text
- lines: 42
- first_non_empty: # Ordinex
- key_items: # Ordinex, # What Ordinex Does, # Why People Use It, # Core Experience, # Built For Real-World Workflows, # Updates, # License
...
- key_items: AnalyticsCharts, ThemeMode, UpdateStatus, autoCheckAndDownloadUpdate, aiSettingsDraft, loadAISettings, saveAISettings, complete_ai_sorting
...
- key_items: AISettings, default_ai_settings, load_or_init_ai_settings, save_ai_settings, complete_ai_sorting, classify_files_with_ai, AIClassificationResult
...
- key_items: should_skip_entry, apply_ai_results, build_ai_folder_hints, classify_unresolved_with_ai, complete_ai_sorting, scan_internal, execute_moves, undo_moves, fetch_history, scan_directory, scan_directory_advanced
...
- lines: 47
- first_non_empty: {
- key_items: key:$schema, key:productName, key:version, key:identifier, key:build, key:app, key:bundle, key:plugins, key:updater, key:pubkey
